...
# -*- coding: utf-8 -*-
"""
Neural Texture Reversion 人脸恢复主脚本

使用方法:
    python restore.py --input_dir ../input/cropped_faces --output_dir ../output/neural_texture
"""
...
class NeuralTextureRestorer:
    """Neural Texture Reversion 人脸恢复器"""
    ...
    def _load_model(self, model_path: Optional[str]) -> NeuralTextureModel:
        """加载预训练模型"""
...
def main():
    """主函数"""
    parser = argparse.ArgumentParser(description="Neural Texture Reversion 人脸恢复")
    ...
    # 创建恢复器
    restorer = NeuralTextureRestorer(model_path=args.model_path, device=args.device)
